                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <form action="OrderController" method="get">
                            <br><input class="btn-dark"  type="submit" name="thanhtoan" value="Thanh toán" /><br>
                        </form>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5>Size: ${item.getSize()}</h5>
                                            <h5>Soluong: ${item.getSoluong()}</h5>
                                            <hr>
                                            
                                                <input class="btn-dark"  type="submit" name="xoa" value="Xóa" />
                                            </form>
                                        </div>
